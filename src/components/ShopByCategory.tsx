      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 sm:mb-12">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold tracking-widest text-slate-700 uppercase">
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 bg-white hover:bg-slate-100 active:bg-slate-200 text-slate-800 text-sm font-semibold px-5 py-2.5 rounded-full border border-slate-300 transition-all duration-200 shadow-sm cursor-pointer group"
            >
          ...
          {MAIN_CATEGORIES.map((category) => (
            ...
            >
              ...
              <div className="aspect-square w-full rounded-xl bg-slate-50/80 flex items-center justify-center p-3 mb-4 overflow-hidden relative group-hover:bg-red-50/30 transition-colors">
                ...
                />
                {category.badge && (
                  <span className="absolute top-2 left-2 text-[10px] font-bold bg-slate-900/80 text-white px-2 py-0.5 rounded-full backdrop-blur-xs">
                    {category.badge}
                  </span>
                )}
              </div>
              ...
              <div className="space-y-3">
                <h3 className="text-xs sm:text-sm font-bold text-slate-900 leading-tight group-hover:text-red-600 transition-colors min-h-[2.5rem] flex items-center">
                  {category.name}
                </h3>
